...
% TODO: Make biblatex stylings into a .sty file.
...
% TODO: Incorporate this into \enquote.
\makeatletter
...
% TODO: Move this to a personal .sty.
% Raise the alphabetical part of an ordinal number.
\usepackage{xstring}
\NewDocumentCommand{\ordinal}{m}{%
  \StrGobbleRight{#1}{2}\textsuperscript{\StrRight{#1}{2}}%
}
